...
{
    default String mumble()
    {
        return mumble(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String mumble(java.util.Map<String, String> context)
    {
        return _iceI_mumbleAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> mumbleAsync()
    {
        return _iceI_mumbleAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> mumbleAsync(java.util.Map<String, String> context)
    {
        return _iceI_mumbleAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_mumbleAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "mumble", null, sync, null);

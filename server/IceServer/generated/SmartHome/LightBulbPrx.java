...
public interface LightBulbPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void setState(boolean newState)
    {
        setState(newState, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setState(boolean newState, java.util.Map<String, String> context)
    {
        _iceI_setStateAsync(newState, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setStateAsync(boolean newState)
    {
        return _iceI_setStateAsync(newState, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setStateAsync(boolean newState, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setStateAsync(boolean iceP_newState, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setState", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeBool(iceP_newState);
                 }, null);
        return f;
    }
